          ...
          <div class="p-8 rounded-2xl bg-white shadow bg-opacity-10">
            ...
            <form class="mt-8 space-y-4" method="post">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="password" type="password" required class="bg-transparent w-full text-white text-mg border-2 border-gray-300 px-4 py-3 rounded-md outline-blue-1000" placeholder="Enter password" />
                </div>
              </div>
              ...
              <div class="!mt-8">
                <button type="submit" class="w-full py-3 px-4 text-mg tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Sign in
                </button>
